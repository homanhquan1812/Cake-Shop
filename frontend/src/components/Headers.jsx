    ...
    <div>
        <header>
            <nav className="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
                ...
                <a className="navbar-brand" href="/"><img style={{width: '47.5px', height: '47.5px'}} src='/img/logo.png'></img></a>
                ...
                <div className="navbar-collapse collapse d-sm-inline-flex justify-content-between">
                    ...
                    </li>     
                    {
                        isLoggedIn ? (
                            <>
                                <li className="nav-item">
                                    <a className="nav-link text-dark" href="/products">Menu</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link text-dark" href={`/info/${userId}`}>Info</a>
                                </li>  
                                {
                                    role == 'User' ? (
                                        <>
                                            ...
                                            <li className="nav-item">
                                                <a className="nav-link text-dark" href="/transactions">History</a>
                                            </li>
                                        </>
                                    ) : (
                                        <>
